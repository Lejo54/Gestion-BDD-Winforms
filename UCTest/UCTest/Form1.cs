    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                da.Fill(Pinpon.MesDatas.DsGlobal, nomtable);
            }

            //affiche les tables de dsglobal

            OneToOneViewUC o = new OneToOneViewUC(Pinpon.MesDatas.DsGlobal);
            o.Dock = DockStyle.Fill; //On remplit le Form avec le UserControl
